...
class Archon < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "fd51b022ba31cf078fe40e90285ab27a2e2d991a1874714b7571c9effb34b65d"
    end
    on_intel do
      url "https://github.com/coleam00/Archon/releases/download/v#{version}/archon-darwin-x64"
      sha256 "23690a2bd142c72f05a0cf569d35ab26a32ac0b66f26edf6fb77a52555cef745"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "bb14423da36fa76d41d0771f8c368de907a3d810a4f7dd72104fa4a8da4cecb4"
    end
    on_intel do
      url "https://github.com/coleam00/Archon/releases/download/v#{version}/archon-linux-x64"
      sha256 "d3fc3df1511d7ed92a3f4d8a42d7a34eb3a0753f8924241194a18a5658d1b610"
    end
  end
